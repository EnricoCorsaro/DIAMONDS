...
int main(int argc, char *argv[])
{
    ...
    int Nobjects = 400;                             // Number of active points evolving within the nested sampling process. 
    int maxNdrawAttempts = 200;                    // Maximum number of attempts when trying to draw a new sampling point.
    ...
    double shrinkingRate = 0.5;                     // Exponent for remaining prior mass in ellipsoid enlargement fraction.
