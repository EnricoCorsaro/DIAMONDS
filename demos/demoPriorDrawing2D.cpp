...
int main()
{
    ...
    double enlargementFraction = 1.0;  
    ...
    for (int i=0; i < Npoints; ++i)
    {
        ...
        while (newPointIsFound == false)
        {
            ...
            for (int priorIndex = 0; priorIndex < ptrPriors.size(); ++priorIndex)
            {
                ...
                // If it failed this criterion for one prior, we can immediately discard the new point, 
