// Compile with:
// clang++ -o demoEllipsoids5D demoEllipsoids5D.cpp -L../build/ -I ../include/ -l diamonds -stdlib=libc++ -std=c++11 -Wno-deprecated-register
//
...
int main()
{
    ...
    ofstream outputFile;
    File::openOutputFile(outputFile,"ellipsoidSample5D.txt");
