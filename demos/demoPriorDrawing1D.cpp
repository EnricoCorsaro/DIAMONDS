// Compile with:
// clang++ -o demoPriorDrawing1D demoPriorDrawing1D.cpp -L../build/ -I ../include/ -l diamonds -stdlib=libc++ -std=c++11 -Wno-deprecated-register
//
...
int main()
{
    ...
    double enlargementFraction = 5.0;  
