//
// Compile with: clang++ -o demoEggbox demoEggbox.cpp -L../build/ -I ../include/ -l multinest -stdlib=libc++ -std=c++0x
// 
...
int main(int argc, char *argv[])
{
    ...
    results.writeParameterEstimationToFile("demoEggbox_ParameterEstimation.txt");
