...
// To compile: clang++ -o BayesianInferenceLinear BayesianInferenceLinear.cpp -L../build/ -I ../include/ -l diamonds -stdlib=libc++ -std=c++11 -Wno-deprecated-register
...
int main(int argc, char *argv[])
{
    ...
    if (argc != 1)
    {
        cerr << "Usage: ./BayesianInferenceLinear" << endl;
        exit(EXIT_FAILURE);
    }
    ...
    string outputPathPrefix = "BayesianInferenceLinear_";
