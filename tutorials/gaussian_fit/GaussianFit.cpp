...
// Source code file "GaussianModel.cpp"

// To compile in Mac OS: 
// clang++ -o GaussianFit GaussianFit.cpp -L../../build/ -I ../../include/ -l diamonds -stdlib=libc++ -std=c++11 -Wno-deprecated-register
// To compile in Linux OS:
// g++ -o GaussianFit GaussianFit.cpp -L../../build/ -I../../include/ -ldiamonds -std=c++11 
...
int main(int argc, char *argv[])
{
    ...
    if (argc != 3)
    {
        cerr << "Usage: ./GaussianFit <data filename> <prior filename>" << endl;
        exit(EXIT_FAILURE);
    }
    ...
    string outputPathPrefix = "GaussianFit_";
    ...
    ArrayXd uncertainties = data.col(1);
    ...
    {
        multiCovariates.segment(observable*Npoints, Npoints) = data.col(observable + 2);
    }
    ...
    int Ndimensions = Nobservables*2;              // Number of parameters for which prior distributions are defined
